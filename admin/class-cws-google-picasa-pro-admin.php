...
// echo $post->post_name;
        ...
        if( $previous > 0 ) {
            ...
            if( $album_id ) {
                ...
                $html[] = "<li><a href=\"?cws_page=$previous&cws_album=$album_id&cws_album_title=$cws_album_title\" id='prev_page'>Atpakaļ</a></li>";
            } else {
                $html[] = "<li><a href=\"?cws_page=$previous\" id='prev_page'>Atpakaļ</a></li>";                
            }
        }
        ...
        if( $next <= $num_pages ) {
            ...
            if( $album_id ){
                $cws_album_title = stripslashes( $cws_album_title );
                $html[] = "<li><a href=\"?cws_page=$next&cws_album=$album_id&cws_album_title=$cws_album_title\" id='next_page'>Tālāk</a></li>";
            } else {
                $html[] = "<li><a href=\"?cws_page=$next\" id='next_page'>Tālāk</a></li>";
            }
        }
